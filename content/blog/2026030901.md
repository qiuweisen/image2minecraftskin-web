...
Record the platform or data source in your journal. If a setup depends on one exact wick or a very narrow price level, check whether the same structure appears on another reputable feed before treating it as a general market example.
