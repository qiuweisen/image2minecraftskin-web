/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 31f2aa0cc088546ad1d5e5bf66cc1432)
...
interface __BaseEnv_Env {
	...
	GEMINI_KEY_POOL: DurableObjectNamespace<import("./src/server").GeminiKeyPool>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "GeminiKeyPool";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GEMINI_API_MODEL" | "VITE_BASE_URL">> {}
}
